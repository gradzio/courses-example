...
} from '../../../application/ports/primary/create-course-command.port';
import { CourseQuery } from '../../../application/ports/primary/course.query';
import {
  DeleteCourseCommandPort,
  DELETE_COURSE_COMMAND,
} from '../../../application/ports/primary/delete-course-command.port';
import {
  GetsCourseQueryPort,
  GETS_COURSE_QUERY,
} from '../../../application/ports/primary/gets-course-query.port';
...
export class CoursesListComponent {
  ...
  constructor(
    @Inject(GETS_COURSE_QUERY) private _getsCourse: GetsCourseQueryPort,
    @Inject(CREATE_COURSE_COMMAND)
    private _createCourse: CreateCourseCommandPort,
    @Inject(DELETE_COURSE_COMMAND)
    private _deleteCourse: DeleteCourseCommandPort
  ) {}
